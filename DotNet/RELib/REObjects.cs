...
namespace RE
{
    ...
    public class REItemType
    {
        ...
        public REItemType(REItemAttribute ItemInfo, System.Type ItemType,string Module)
        {
        ...
        {
            return ItemType.GetConstructor(System.Type.EmptyTypes).Invoke(new object[] { }) as REBaseItem;
        }
    }
